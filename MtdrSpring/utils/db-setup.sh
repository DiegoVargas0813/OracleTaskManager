...
CREATE TODOUSER.TABLE MANAGERS (
...
CREATE TODOUSER.TABLE USERS (
    ...
    CREATION_TS TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    MANAGER_ID INT,
    CONSTRAINT FK_USER_MANAGER FOREIGN KEY (MANAGER_ID) REFERENCES MANAGERS(MANAGER_ID) ON DELETE CASCADE
);
CREATE TODOUSER.TABLE TASKS (
    ...
    REAL_HOURS INT,
    SPRINT_ID INT,
    CONSTRAINT FK_TASK_SPRINT FOREIGN KEY (SPRINT_ID) REFERENCES SPRINTS(SPRINT_ID) ON DELETE CASCADE
);
CREATE TODOUSER.TABLE ASSIGNMENTS (
...
CREATE TODOUSER.TABLE ISSUES (
    ...
    CONSTRAINT FK_ISSUE_SPRINT FOREIGN KEY (SPRINT_ID) REFERENCES SPRINTS(SPRINT_ID) ON DELETE CASCADE
);
commit;
!
